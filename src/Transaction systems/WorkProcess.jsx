...
const steps = [
  {
    ...
    title: "Assessment",
    description:
      "We review your current transaction flow, approval structure, and risk exposure.",
      icon: <Search size={20} />
  },
  {
    id: "2",
    title: "Design",
    description:
      "We define authorization rules, approval thresholds, and execution logic.",
  ...
  },
  {
    ...
    description:
      "We build structured transaction pipelines and integrate multi party controls.",
    icon: <Rocket size={20} />
  },
  {
    id: "4",
    title: "Validation",
    description:
      "We test transaction flows under real conditions including failure and attack scenarios.",
    ...
    <section id="workprocess" className="bg-[#fff] py-20 md:py-28 overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-10 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto" data-aos="fade-up">
          ...
          <h1 className="mt-5 text-4xl md:text-6xl font-bold text-[#2563EB] leading-tight">
            Our Approach
          </h1>

          <p className="mt-6 text-[#5B6475] text-base md:text-xl leading-relaxed max-w-3xl mx-auto">
            A four-stage methodology grounded in real transaction conditions, threat scenarios, andoperational reality.
          </p>
        </div>
