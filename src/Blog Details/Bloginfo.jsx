  ...
  return (
    ...
    <div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-12 grid md:grid-cols-3 gap-10">
            ...
            <br /> Many online customers prefer decentralized payment methods. These methods support borderless transactions and faster settlement. Businesses now explore new ways to improve website payment processing.
            <br /> A modern payment infrastructure allows websites to accept digital currencies securely. Companies that invest in strong payment gateway integration can expand their global reach.
