...
const Hero = () => {
  return (
    <section className="bg-[#EEF3FA] py-12 lg:py-32 xl:py-28 md:py-32 overflow-hidden justify-center mx-auto">
      <div className="md:max-w-5xl lg:max-w-6xl xl:max-w-screen-xl duration-500 mx-auto px-5 xl:px-10 lg:px-10 md:px-10 grid lg:grid-cols-2 gap-10 items-center justify-center">
          {/* RIGHT IMAGE */}
